...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self.btnCheckMark setImage:[UIImage imageNamed:@"form_check_select"] forState:UIControlStateSelected];
        [self.btnCheckMark setImage:[UIImage imageNamed:@"form_check_nomal"] forState:UIControlStateNormal];
    }
    return self;
}
